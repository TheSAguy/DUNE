...
my_worker.max_health = 5
my_worker.vision_distance = 10
my_worker.pollution_to_join_attack = 10000
my_worker.attack_parameters.range = 6
my_worker.attack_parameters.min_attack_distance = 4
my_worker.attack_parameters.ammo_type.action.action_delivery[1].target_effects[1].damage.amount = 1
